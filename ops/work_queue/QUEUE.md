...
| 5 | docs/api-reference | API reference documentation | open | unassigned | #1126, #1130 | Do not write API docs against a moving target. Wait for CI green. |
| 6 | feat/QGIA | QGIA integration hooks | needs-decision | unassigned | arch/layer-canonization | Pending architecture decision on PAT routing. Aurora will annotate when ready to proceed. |
