...
def fix_logging_fstring_interpolation(file_path: str) -> bool:
    ...
    # Replace logging f-strings with % formatting
    patterns = [
...
def remove_empty_fstrings(file_path: str) -> bool:
    ...
    # Find f-strings without interpolation and convert to regular strings
    pattern = r'"([^"]*)"'
...
def main():
    ...
    for py_file in python_files:
        ...
        file_fixes = process_file_advanced(str(py_file))
