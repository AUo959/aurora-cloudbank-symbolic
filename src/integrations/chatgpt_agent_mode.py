...
class ChatGPTAgentModeIntegration:
        ...
        self.tools_registry = {
            ...
            "geometric_algebra": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "operation": {"type": "string", "enum": ["mult", "add", "sub"], "description": "Operation type"}
                    },
            ...
            "session_management": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "action": {"type": "string", "enum": ["create", "update", "get", "delete"], "description": "Session action"},
    ...
    async def execute_tool(self, tool_name: str, parameters: Dict[str, Any], session_id: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    async def _handle_geometric_algebra(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if operation == "mult":
                ...
                result = f"({expr_a}) · ({expr_b})"  # Use · for geometric product, not ∧
            elif operation == "add":
    ...
    async def _handle_system_status(self, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if detail_level in ["detailed", "full"]:
            status.update({
                ...
                "capabilities": self.config.get("agent_capabilities", []),
                "sonnet4_status": sonnet4_hub.get_global_status() if hasattr(sonnet4_hub, 'get_global_status') else "unknown",
        ...
        if detail_level == "full":
            status.update({
                "session_details": {sid: {"created": s["created"], "last_accessed": s["last_accessed"]} 
                                  for sid, s in self.sessions.items()},
                "tool_registry": {name: {"description": tool["description"]} 
