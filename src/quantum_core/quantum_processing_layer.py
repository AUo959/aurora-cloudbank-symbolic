...
class QuantumProcessingLayer:
    ...
    def __init__(self, num_qubits=8):
        ...
        try:
            ...
            raise ImportError(
                "Qiskit and qiskit-aer are required to use QuantumProcessingLayer."
            ) from exc
    ...
    def create_quantum_circuit(self, circuit_name, operations):
        ...
        qreg = self._QuantumRegister(self.num_qubits, "q")
        creg = self._ClassicalRegister(self.num_qubits, "c")
...
__all__ = ["QuantumProcessingLayer", "NativeQuantumProcessingLayer"]
