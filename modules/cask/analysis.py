...
def generate_technical_specifications(output_csv: Optional[str] = None) -> pd.DataFrame:
...
def generate_vs_sota_comparison(output_csv: Optional[str] = None) -> pd.DataFrame:
...
def generate_risk_assessment(output_csv: Optional[str] = None) -> pd.DataFrame:
