...
"""
Opal2 Plugin System
Provides plugin management functionality for Aurora Diff Integration
"""

class PluginSystem:
    """Plugin management system for Opal2"""
    ...
    async def register_plugin(self, name, plugin_info):
        """Register a plugin"""
...
class PluginSystem:
    ...
    async def register_plugin(self, plugin_name, plugin_info):
        """Register a plugin"""
