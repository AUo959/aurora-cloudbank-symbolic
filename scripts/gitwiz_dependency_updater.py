...
class DependencyAutoUpdater:
    ...
    pass
                    ...
                    print("📦 Found {len(outdated)} outdated Python packages")
    ...
    pass
                    ...
                    print("📦 Found {len(outdated)} outdated Node.js packages")
                    for pkg_name, info in list(outdated.items())[:5]:  # Show first 5
                        print("  • {pkg_name}: {info['current']} → {info['latest']}")
...
def main():
    ...
    pass
        ...
        print("  Node.js packages scanned: {len(result['node_scan'].get('outdated', []))}")
