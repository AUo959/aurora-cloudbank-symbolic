...
if __name__ == "__main__":
    ...
    try:
        ...
        geo_result = loop.run_until_complete(agent.execute_tool("geometric_algebra", {
            "expression_a": "e1 + e2",
            "expression_b": "e2 + e3",
            "operation": "mult"
        }))
        ...
        symbolic_result = loop.run_until_complete(agent.execute_tool("symbolic_processing", {
