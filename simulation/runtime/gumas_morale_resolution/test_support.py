...
def state(*, elapsed=100000, macrostep=10, vessels=None):
    core,norm,composite=_phase7_identity()
    s={"schema":"aurora://simulation/gumas/phase7-test-state/v1","macrostep_index":macrostep,"elapsed_ms":elapsed,"vessels":vessels or [vessel("L1","loyalist","F-L"),vessel("L2","loyalist","F-L"),vessel("R1","rebel","F-R"),vessel("R2","rebel","F-R")],"phase7_source_identity":core,"phase7_semantic_normalizer_source_identity":norm,"phase7_composite_source_sha256":composite}
