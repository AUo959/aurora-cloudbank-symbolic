...
def test_create_checkpoint(client, create_payload):
    ...
    resp = client.post("/checkpoint/create", json=create_payload)
...
def test_list_checkpoints(client, create_payload):
    ...
    client.post("/checkpoint/create", json=create_payload)
...
def test_get_checkpoint_by_id(client, create_payload):
    ...
    post = client.post("/checkpoint/create", json=create_payload)
