            ...
            if action == 'delete' and branch['is_merged']:
                ...
                if confirm and not self.dry_run:
                    try:
                        ...
                        subprocess.run(cmd, capture_output=True, cwd=self.repo_path, shell=False, check=False)
...
def main():
    ...
    parser.add_argument('--confirm', action='store_true', help='Actually execute deletions (not dry-run)')
